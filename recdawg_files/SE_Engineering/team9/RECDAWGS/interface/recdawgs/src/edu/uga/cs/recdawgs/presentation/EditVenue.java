...
public class EditVenue extends HttpServlet {
    ...
    static  String            resultTemplateName = "FindAllVenues-Result.ftl";
            ...
            throws ServletException, IOException
    {
        ...
        Student             u = null;
        String              nameOfSportsVenue = req.getParameter("venue");
        resultTemplateName = "EditVenue-Result.ftl";
        nameOfSportsVenue = nameOfSportsVenue.replace("Edit ", "");
        ...
        try {
            SportsVenue theSportsVenue = logicLayer.findSportsVenue(nameOfSportsVenue);
            root.put("name", theSportsVenue.getName());
            if (theSportsVenue.getIsIndoor())
                root.put("indoor", "Yes");
            else
                root.put("indoor", "No");
            root.put("address", theSportsVenue.getAddress());
        } catch( Exception e) {
            e.printStackTrace();
            ...
            throws ServletException, IOException
    {
        ...
        if (req.getParameter("indoor").equalsIgnoreCase("yes")) isIndoor = true;
        
        if (newName != null) {
            try {
                long id = logicLayer.findSportsVenue(nameOfSportsVenue).getId();
                logicLayer.updateSportsVenue(id, newName, isIndoor, req.getParameter("address"));
