...
public class EditTeam extends HttpServlet {
            ...
            throws ServletException, IOException
    {
        ...
        nameOfTeam = nameOfTeam.replace("Edit ", "");
            ...
            throws ServletException, IOException
    {
        ...
        if (newName != null) {
            try {
                long id = logicLayer.findTeam(nameOfTeam).getId();
                logicLayer.updateTeam(id, newName);
                rv = logicLayer.findTeamMembers(newName);
                root.put( "team", newName );
