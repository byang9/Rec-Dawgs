...
<body>
    ...
    <section id="about" class="container content-section text-center">
        <div class="row">
            <form method=get action="http://localhost:8080/recdawgs_team9/CreateScoreReport">
            <div class="col-lg-8 col-lg-offset-2">
                <h1>All Matches</h1>
                <p>Click on a match to add a score report</p>
                </div>
                <table width="100%"  border="0" cellpadding="2" cellspacing="4" >
                 ...
                 <#list reports as report>
                  <tr>
                      <td><input type=submit name="id" value=${match[0]} style="text-transform: none;background-color:transparent;color:rgba(66,220,163,1);"></td>
                      <td>${match[1]}</td>
                      <td>${match[2]}</td>
                      <td>${match[3]}</td>
                      <td>${match[4]}</td>
