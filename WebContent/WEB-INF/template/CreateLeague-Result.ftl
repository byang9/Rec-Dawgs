        ...
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <form method=post action="http://uml.cs.uga.edu:8080/logan_jahnke_currency/CreateLeague">
                    ...
                    <h4>Maximum Teams: </h4><INPUT NAME="maxTeams" TYPE=number size=50 required></INPUT>
                    <h4>Minimum Members: </h4><INPUT NAME="minMembers" TYPE=number size=50 required></INPUT>
                    <h4>Maximum Members: </h4><INPUT NAME="maxMembers" TYPE=number size=50 required></INPUT>
                    <h4>Match Rules: </h4><INPUT NAME="matchRules" TYPE=text size=250 required></INPUT>
                    <h4>League Rules: </h4><INPUT NAME="leagueRules" TYPE=text size=250 required></INPUT>
                    <br>
