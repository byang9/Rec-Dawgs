    ...
    <section id="about" class="container content-section text-center">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <h1>Edit ${name}</h1>
                <form method=post action="http://localhost:8080/recdawgs_team9/EditVenue">
                    <h4>Venue Name: </h4><INPUT NAME="name" value="${name}" TYPE=text size=50 required></INPUT>
                    <h4>Indoor (yes or no): </h4><INPUT NAME="indoor" value="${indoor}" TYPE=text size=50 required></INPUT>
                    <h4>Address: </h4><INPUT NAME="address" TYPE=text value="${address}" size=50 required></INPUT>
                    <br>
                    <INPUT type=submit name="venue" value="Edit ${name}"></INPUT>
                </form>
            </div>
        </div>
        <hr>
